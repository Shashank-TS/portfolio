      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            ...
            {/* Card */}
            <div
              className={`relative w-[90%] sm:w-[calc(50%-2rem)] md:w-[calc(50%-2rem)] p-4 sm:p-8 mt-2 sm:mt-0 rounded-2xl  border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] ${
                index % 2 === 0 ? "sm:ml-0" : "sm:mr-0"
              } transform transition-transform duration-300 hover:scale-105`}
            >
              <div className="flex items-center space-x-4 sm:space-x-6">
                {/* Logo */}
                <div className="w-16 h-16 sm:w-20 sm:h-18 bg-white rounded-md overflow-hidden">
                  <img
                    src={experience.img}
                    alt={experience.company}
